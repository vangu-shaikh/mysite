...
1. Go to the project directory
   ...
   Then go to the template folder you want to use. For example, if you want to use the Hey Buddy template, then go to the Hey Buddy folder.
...
![Hey Buddy Dark](public/screenshot_01.png)
![Hey Buddy Dark](public/screenshot_02.png)
